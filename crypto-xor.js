...
(function () {
    ...
    function wideMD5(value) {
        return MD5(value) + MD5(value + "S9VZbHNWkbV3KgseEPyMAx6u")
    }
    ...
    // Uses the input string is xor-d with a random number generator to generate a new string.
    // Xor-ing with the same secret will restore the original string:
    //   const msg,secret = ...
    //   assert(msg === bitmangle(secret, bitmangle(secret, msg))) // Should be always be true.
    // Example usage:
    //   const encodedStr = bitmangle("pa$$Word", "Hello, world!") // Return type string.
    ...
    globalThis.cryptoXor = function(secret, msg) {
        ...
        for (let i = 0; i < msg.length; i++) {
            ...
            const encodedCodePoint = codePoint ^ randomByte
